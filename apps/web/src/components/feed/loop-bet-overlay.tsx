  ...
  return (
    <div className="absolute inset-0 z-20 pointer-events-none">
      <div className="pointer-events-auto absolute left-4 right-4 top-3 max-h-[30vh] overflow-y-auto">
        <p className="mb-2 text-center text-xs font-medium text-white/90 drop-shadow-md">
        ...
        <div className="space-y-2">
          {markets.map((market) => {
            ...
            return (
              <div key={market.id} className="space-y-1">
                <p className="text-xs text-white/95 drop-shadow-md">
                ...
                <div className="flex gap-1.5">
                  <button
                    ...
                    className="rounded-md bg-emerald-500/50 px-2 py-1 text-[11px] font-semibold text-white transition hover:bg-emerald-500/70 disabled:opacity-50 touch-manipulation"
                  >
                  ...
                  <button
                    ...
                    className="rounded-md bg-rose-500/50 px-2 py-1 text-[11px] font-semibold text-white transition hover:bg-rose-500/70 disabled:opacity-50 touch-manipulation"
                  >
          ...
          {markets.length === 0 && (
            <p className="py-3 text-center text-xs text-white/60 drop-shadow-md">No predictions yet</p>
          )}
        </div>
      </div>
    </div>
